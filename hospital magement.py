...
def login():
        ...
        with con:
                cursor=con.cursor()
        cursor.execute('CREATE TABLE IF NOT EXISTS Register (first_name TEXT NOT NULL ,last_name TEXT NOT NULL ,age INTEGER(2) NOT NULL ,gender NOT NULL,city TEXT,address TEXT,user TEXT NOT NULL ,passwd TEXT NOT NULL,very_pass TEXT NOT NULL ,docter TEXT  ,day TEXT ,month TEXT ,year INTEGER(4),mobile INTEGER(10) )')
